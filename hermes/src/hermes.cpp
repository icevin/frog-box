...
#line 1 "c:/Users/icevi/Documents/GitHub/frog-box/hermes/src/hermes.ino"
#include "Particle.h"
#include "softap_http.h"

void myPage(const char *url, ResponseCallback *cb, void *cbArg, Reader *body, Writer *result, void *reserved);
int random2(int maxRand);
void setup();
void loop();
...
int setSRV(String command);
void testdrawbitmap(const uint8_t *bitmap, uint8_t w, uint8_t h);
#line 4 "c:/Users/icevi/Documents/GitHub/frog-box/hermes/src/hermes.ino"
...
//                                                                                                                                     dddddddd
// UUUUUUUU     UUUUUUUU                                                                     CCCCCCCCCCCCC                             d::::::d
// U::::::U     U::::::U                                                                  CCC::::::::::::C                             d::::::d
// U::::::U     U::::::U                                                                CC:::::::::::::::C                             d::::::d
// UU:::::U     U:::::UU                                                               C:::::CCCCCCCC::::C                             d:::::d
//  U:::::U     U:::::U    ssssssssss       eeeeeeeeeeee    rrrrr   rrrrrrrrr         C:::::C       CCCCCC   ooooooooooo       ddddddddd:::::d     eeeeeeeeeeee
//  U:::::D     D:::::U  ss::::::::::s    ee::::::::::::ee  r::::rrr:::::::::r       C:::::C               oo:::::::::::oo   dd::::::::::::::d   ee::::::::::::ee
//  U:::::D     D:::::Uss:::::::::::::s  e::::::eeeee:::::eer:::::::::::::::::r      C:::::C              o:::::::::::::::o d::::::::::::::::d  e::::::eeeee:::::ee
//  U:::::D     D:::::Us::::::ssss:::::se::::::e     e:::::err::::::rrrrr::::::r     C:::::C              o:::::ooooo:::::od:::::::ddddd:::::d e::::::e     e:::::e
//  U:::::D     D:::::U s:::::s  ssssss e:::::::eeeee::::::e r:::::r     r:::::r     C:::::C              o::::o     o::::od::::::d    d:::::d e:::::::eeeee::::::e
//  U:::::D     D:::::U   s::::::s      e:::::::::::::::::e  r:::::r     rrrrrrr     C:::::C              o::::o     o::::od:::::d     d:::::d e:::::::::::::::::e
//  U:::::D     D:::::U      s::::::s   e::::::eeeeeeeeeee   r:::::r                 C:::::C              o::::o     o::::od:::::d     d:::::d e::::::eeeeeeeeeee
//  U::::::U   U::::::Ussssss   s:::::s e:::::::e            r:::::r                  C:::::C       CCCCCCo::::o     o::::od:::::d     d:::::d e:::::::e
//  U:::::::UUU:::::::Us:::::ssss::::::se::::::::e           r:::::r                   C:::::CCCCCCCC::::Co:::::ooooo:::::od::::::ddddd::::::dde::::::::e
//   UU:::::::::::::UU s::::::::::::::s  e::::::::eeeeeeee   r:::::r                    CC:::::::::::::::Co:::::::::::::::o d:::::::::::::::::d e::::::::eeeeeeee
//     UU:::::::::UU    s:::::::::::ss    ee:::::::::::::e   r:::::r                      CCC::::::::::::C oo:::::::::::oo   d:::::::::ddd::::d  ee:::::::::::::e
//       UUUUUUUUU       sssssssssss        eeeeeeeeeeeeee   rrrrrrr                         CCCCCCCCCCCCC   ooooooooooo      ddddddddd   ddddd    eeeeeeeeeeeeee

int LED_R = WKP;
int LED_G = RX;
int LED_B = TX; // R and G are switched in wiring oops
int SERVO = A5;
int BUTTON = D6;
...
void setup()
{
  ...
  analogWriteResolution(SERVO, 12);

  Particle.function("set_rgb", setRGB);
  Particle.function("set_servo", setSRV);
  Particle.function("pend_message", pend_message);
  Particle.function("set_enable", enable);

  // 0x3C for some reason is 128x64 forme
...
unsigned int servoToPWM(int input)
{
  ...
  return map(input, 0, 180, 100, 500);
}
...
int setRGB(String command)
{
  ...
  else if (enable_led == 1)
  {
    analogWrite(LED_R, constrain(command.substring(0, 3).toInt(), 0, 255));
